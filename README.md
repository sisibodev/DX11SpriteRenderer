...
50,000개 스프라이트 기준 — **드로우콜 50,000 → 4, 프레임 타임 22.5배 개선**

| 엔티티 | 최적화 없음 | 전체 적용 | 개선 |
|---:|---:|---:|---:|
| 1,000 | 0.45 ms | **0.12 ms** | 3.8배 |
| 5,000 | 2.18 ms | **0.14 ms** | 15.6배 |
| 10,000 | 4.20 ms | **0.22 ms** | 19.1배 |
| 50,000 | 25.86 ms (39 fps) | **1.15 ms (873 fps)** | **22.5배** |
...
- **텍스처 정렬** — 그리기 전 텍스처 기준 정렬로 상태 변경 최소화
...
```
스프라이트 : 12829 | 드로우콜 : 4(1, 2, 1) | 1.15 ms (873 fps)
